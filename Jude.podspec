...
Pod::Spec.new do |s|
  ...
  s.name         = "Jude"
  s.version      = "0.0.1"
  s.summary      = "JSON parser for Swift 3"
  ...
  s.description  = <<-DESC
  Jude是一款JSON解析库，目前支持Swift 3。
                   DESC

  s.homepage     = "https://github.com/cikelengfeng/Jude"
  ...
  s.source       = { :git => "https://github.com/cikelengfeng/Jude.git", :tag => s.version.to_s }
  ...
  s.source_files  = "Jude/**/*.swift", "Jude/**/*.tokens"
  s.exclude_files = "Jude/Exclude"
